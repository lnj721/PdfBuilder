...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    private FrescoImageView mThumbnail;
    private CheckView mCheckView;
    private FrescoImageView mGifTag;
    ...
    private void init(Context context) {
        ...
        mThumbnail = (FrescoImageView) findViewById(R.id.media_thumbnail);
        mCheckView = (CheckView) findViewById(R.id.check_view);
        mGifTag = (FrescoImageView) findViewById(R.id.gif);
    ...
    public interface OnMediaGridClickListener {
        ...
        void onThumbnailClicked(FrescoImageView thumbnail, Item item, RecyclerView.ViewHolder holder);
