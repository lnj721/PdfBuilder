...
import com.zhihu.matisse.internal.ui.widget.ZhiHuZoomImageView;
...
public class PreviewItemFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ZhiHuZoomImageView image = (ZhiHuZoomImageView) view.findViewById(R.id.image_view);
//        image.setDisplayType(ImageViewTouchBase.DisplayType.FIT_TO_SCREEN);
    ...
    public void resetView() {
        if (getView() != null) {
            ((ZhiHuZoomImageView) getView().findViewById(R.id.image_view)).reset();
        }
    }
}
