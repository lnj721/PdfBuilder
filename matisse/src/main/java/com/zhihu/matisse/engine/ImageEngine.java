...
public interface ImageEngine {
     ...
     * @param imageView   QiyuesuoImageView widget
     * @param uri         Uri of the loaded image
     */
    void loadThumbnail(Context context, int resize, Drawable placeholder, FrescoImageView imageView, Uri uri);
     ...
     * @param uri         Uri of the loaded image
     */
    void loadGifThumbnail(Context context, int resize, Drawable placeholder, FrescoImageView imageView, Uri uri);
     ...
     * @param uri       Uri of the loaded image
     */
    void loadImage(Context context, int resizeX, int resizeY, FrescoImageView imageView, Uri uri);
     ...
     * @param uri       Uri of the loaded image
     */
    void loadGifImage(Context context, int resizeX, int resizeY, FrescoImageView imageView, Uri uri);
